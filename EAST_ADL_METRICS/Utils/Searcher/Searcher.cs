...
namespace EAST_ADL_METRICS.Utils.Searcher
{
    public class Searcher
    {
        ...
        /// <returns></returns>
        public List<XElement> parentElementList(XDocument xml, string firstKeyword, string secondKeyword = null, string thirdKeyword = null, string fourthKeyword = null)
        {
            List<XElement> parentList = xml.Descendants()
                                            .Where(node => node.Name == firstKeyword
                                                        || node.Name == secondKeyword
                                                        || node.Name == thirdKeyword
                                                        || node.Name == fourthKeyword).ToList();
